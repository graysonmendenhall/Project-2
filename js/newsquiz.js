...
(function($) {
	...
	var right_answers = 0;
		...
		if (right_answers == 0) {
		    $("#quiz-reply").html("Sorry, none correct.");
		    console.log(right_answers);
		}
		
		if (right_answers ==1) {
		    $("#quiz-reply").html("<h3 class='red'>Keep Trying</h3>");
		    console.log(right_answers);
		}
		
		if (right_answers >=5) {
		    $("#quiz-reply").html("Not Bad")
		}
		
		if (right_answers >=7) {
		    $("#quiz-reply").html("Very Good")
		}
		
		if (right_answers >=9) {
		    $("#quiz-reply").html("<h3 class='blue'>Amazing!</h3>")
		}
